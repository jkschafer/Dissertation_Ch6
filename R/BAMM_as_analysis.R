...
# Load data
tree <- read.tree("./Results/Data/BAMM_out/AS_phy/springer_primates_as_tree.phy")
edata <- getEventData(tree, 
                      eventdata = "./Results/Data/BAMM_out/AS_phy/event_data.txt", 
                      burnin = 0.1)
mcmcout <- read.csv("./Results/Data/BAMM_out/AS_phy/mcmc_out.txt", 
                    header = TRUE)
